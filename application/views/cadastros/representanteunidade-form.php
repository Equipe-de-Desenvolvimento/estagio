<div class="panel-body">
    <form action="<?=base_url()?>cadastros/pacientes/gravarrepresentanteunidade" method="POST">
        <div class="row">
            <div class="col-lg-3">
                <label for="">Nome</label>
                <input type="text" name="nome" class="form-control" value="<?=@$obj[0]->nome?>" required>
                <input type="hidden" name="representante_unidade_id" value="<?=$representante_unidade_id?>">
            </div>
